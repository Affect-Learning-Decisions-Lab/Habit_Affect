...
dev.print(pdf, file.path(figures_path,'Figure_Exp2Exp1_symptomsNetwork.pdf'))
dev.off()
...
Table to get the assess of the precision the edges estimation for automaticity
...
Table to get the assess of the precision the edges estimation for routine
...
Let s compute bridge symptoms -- this is not reported in the main manuscript
...
Lets compute the bridge stability -- not reported in the main manuscript
