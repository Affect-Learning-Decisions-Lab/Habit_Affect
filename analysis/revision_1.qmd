...
pp <- ggplot(data = experiment_1_questionnaires, aes (x = score, fill = questionnaire)) +
  ...
  geom_vline(data = cutoff_values, mapping = aes(xintercept = cutoff)) +
...
# Khazaal, Y., Chatton, A., Rothen, S., Achab, S., Thorens, G., Zullino, D., & Gmel, G. (2016). Psychometric properties of the 7-item game addiction scale among french and German speaking adults. BMC Psychiatry, 16(1), 132. https://doi.org/10.1186/s12888-016-0836-3
  ...
  # “sometimes” or more on all seven items were defined as monothetic gamers (“pathological gaming”), and those who scored “sometimes” or more on at least half of the items (four to six of seven items) were defined as polythetic gamers (excessive gaming).
