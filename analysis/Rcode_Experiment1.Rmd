---
title: "Rcode Habit components Experiment 1"
author: "Lavinia Wuensch, Yoann Stussi, Théo Vernede, Eva R Pool"
date: "`r format(Sys.time(), '%d %B, %Y')`"
output: html_document
---

# R Code for the Experiemnt 1
...
# only for experiment 1 we remove participants that have missing data in at least on of the questionnaires of interest
...
# select only participant that do not have missing data on the questionnaire of interest
...
table_demo_exp1 <- JWileymisc::egltable(c("Age", "Genre"), 
  ...
  kbl(caption ="Demografics of sample used for Experiment 1", digits = 2)    %>%
...
# let's print the plot in a pdf document
ggsave(paste0(figures_path, "/Figure_exp1_cohs_subscales.pdf"), ppp, width = 25, height = 12, units = "cm")
...
dev.print(pdf, file.path(figures_path,'Figure_Exp1_CorrelationalSyptomes.pdf'))
dev.off()
```
...
dev.print(pdf, file.path(figures_path,'Figure_Exp1_Factors.pdf'))
dev.off()
...
dev.print(pdf, file.path(figures_path,'Figure_Exp1_Factors_correlation.pdf'))
dev.off()
...
dev.print(pdf, file.path(figures_path,'Figure_Exp1_Network.pdf'))
...
To determine the sample size of experiment 1 we can use the sample from experiment 1 and run a power analysis.
...
to estimate the strength, betweeness and closness of the network
